function [r_test,mse_test,cv_r,opt_lmb,mdl] = cv_then_test_GT(stim,eeg,train_tr,test_tr,Fs,dir,minlag,maxlag,lambdas, megasubj)
...
% cv_r = nanmean(nanmean(stats.r,3),1)'; %changed RB
...
[~,st_test] = mTRFpredict(stim(test_tr),megasubj(test_tr),mdl);
r_test = st_test.r;
