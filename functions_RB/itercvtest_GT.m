function [stats,mdl] = itercvtest_GT(stim,eeg,Fs,dir,minlag,maxlag,lambdas, megasubj)
...
for n = 1:ntr
    ...
    [r_test(n,:),mse_test(n,:),cv_r(:,n),opt_lmb(n),mdl{n}] = ...
        cv_then_test_GT(stim,eeg,train_tr,test_tr,Fs,dir,minlag,maxlag,lambdas, megasubj);
end
